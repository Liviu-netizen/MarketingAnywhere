...
export default function SearchPage() {
    ...
    const [searchQuery, setSearchQuery] = useState(searchParams.get('q') || 'Marketing Strategy')
    ...
    return (
        <MobileContainer className="bg-background-light dark:bg-background-dark">
            ...
            <main className="px-4 py-4 flex flex-col gap-4">
                        ...
                        <div className="flex items-center justify-between pt-3 border-t border-slate-100 dark:border-slate-800">
                            <div className="flex flex-col">
                                ...
                                <span className="font-bold text-slate-900 dark:text-white">
                                    ${agency.pricing.starting_monthly >= 1000 ? `${(agency.pricing.starting_monthly / 1000).toFixed(1)}k` : agency.pricing.starting_monthly}
                ...
                {/* Loading skeleton */}
                <div className="bg-white dark:bg-card-dark rounded-xl p-4 shadow-sm border border-slate-100 dark:border-transparent animate-pulse">
